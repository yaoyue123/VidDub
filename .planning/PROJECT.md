...
**Target features:**
- **多维度跟踪** — 关键词跟踪、博主(频道)跟踪、playlist 跟踪、热点跟踪、主题跟踪
- **双模式** — 手动搜索即时结果 + 保存跟踪目标后自动扫描新内容
- **筛选条件** — 支持按播放量、发布时间、时长等条件筛选
- **移除旧推荐系统** — 不恢复 v4.0 五维评分引擎
- **Bug 修复** — YouTube 视频封面不显示 + 重复下载目录
...
### Active (v5.1 Discover 页面重构与 Bug 修复)

<!-- Current scope. Building toward these. -->

- [ ] 多维度内容跟踪（关键词、博主、playlist、热点、主题）
- [ ] 手动搜索与自动扫描双模式
- [ ] 视频筛选条件（播放量、发布时间、时长等）
- [ ] 旧推荐系统完全移除
- [ ] YouTube 视频封面正常显示
...
---
*Last updated: 2026-06-29 — v5.1 Discover 页面重构与 Bug 修复 milestone started (v5.0 completed)*
